    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="<?php echo U('cate/add_cate');?>" method="post" autocomplete="off">
            ...
            <div class="form-group">
              ...
              <select id="category-fname" class="form-control" name="parent_id">
                ...
                <?php if(is_array($p_cate)): foreach($p_cate as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["cate_name"]); ?></option><?php endforeach; endif; ?>
              </select>
        ...
        <div class="col-md-7">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
              <?php if(is_array($cate_res)): foreach($cate_res as $key=>$v): ?><tr>
                  <td><?php echo ($v["id"]); ?></td>
                  <td><?php echo ($v["cate_name"]); ?></td>
                  <td><?php echo ($v["alias"]); ?></td>
                  <td></td>
                  <td><a href="javascript:void(0)";>修改</a> <a rel="1">删除</a></td>
