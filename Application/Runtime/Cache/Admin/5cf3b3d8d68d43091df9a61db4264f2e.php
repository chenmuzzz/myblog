...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="<?php echo U('article/edit_article');?>" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">撰写新文章</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              <input type="text" id="article-title" name="title" value="<?php echo ($res["title"]); ?>" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="content" type="text/plain"><?php echo ($res["content"]); ?></script>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>关键字</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" name="keywords" autocomplete="off" value="<?php echo ($res["keywords"]); ?>">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="description" autocomplete="off"><?php echo ($res["description"]); ?></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="输入新标签" name="" autocomplete="off" value="<?php echo ($res["tags"]); ?>">
                <span class="prompt-text">多个标签请用英文逗号,隔开</span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>标题图片</span></h2>
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="pictureUpload" name="image" autocomplete="off">
              </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>公开度：</label>
                    <input type="radio" name="display" value="1" <?php if($res["display"] == 1): ?>checked<?php endif; ?>/>公开
                    <input type="radio" name="display" value="0" <?php if($res["display"] == 0): ?>checked<?php endif; ?>/>加密
                </p>
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="" value="<?php echo (date('y-m-d H:i:s',$res["created_time"])); ?>" /></span></p>
              </div>
                <input type="hidden" value="<?php echo ($res['id']); ?>" name="article_id">
              <div class="add-article-box-footer">
...
<script src="/oa/Public/Admin/lib/ueditor/ueditor.config.js"></script> 
<script src="/oa/Public/Admin/lib/ueditor/ueditor.all.min.js"> </script> 
<script src="/oa/Public/Admin/lib/ueditor/lang/zh-cn/zh-cn.js"></script>  
